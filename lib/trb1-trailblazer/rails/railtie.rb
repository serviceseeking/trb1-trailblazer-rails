...
require "trb1-trailblazer/loader"
  ...
  module Trailblazer
    class Railtie < ::Rails::Railtie
      ...
      def self.load_for(app)
        Loader.new.(debug: true, prepend: AllModelFiles, root: app.root) { |file| require_dependency(file) }
      end

      # This is to autoload Operation::Dispatch, etc. I'm simply assuming people find this helpful in Rails.
      initializer "trb.trailblazer.library_autoloading" do
        require "trb1-trailblazer/autoloading"
      end

      # thank you, http://stackoverflow.com/a/17573888/465070
      initializer 'trb.trailblazer.install', after: "reform.form_extensions" do |app|
        # the trb autoloading has to be run after initializers have been loaded, so we can tweak inclusion of features in
        # initializers.
        reloader_class.to_prepare do
          Trb1::Trailblazer::Railtie.load_concepts(app)
        end
      end
      ...
      initializer "trb.trailblazer.application_controller" do
